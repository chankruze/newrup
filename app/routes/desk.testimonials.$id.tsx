...
import { deleteTestimony, getTestimony } from "~/dao/testimonials.server";
...
export const action = async ({ request, params }: ActionFunctionArgs) => {
  ...
  switch (__action) {
    case "delete": {
      const { ok, error } = await deleteTestimony(params.id as string);

      if (ok) return redirect(`/desk/testimonials`);
