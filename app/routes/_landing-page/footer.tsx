    ...
    <footer className="border-t px-[5vw] py-9 lg:py-16">
      <div className="max-w-8xl mx-auto grid grid-cols-2 gap-12 md:grid-cols-4 xl:grid-cols-8">
        <div className="col-span-2 space-y-6 md:col-span-4">
          <h1 className="font-outfit text-2xl font-bold text-title md:text-4xl">
            {SITE_TITLE}
          </h1>
          <p className="max-w-md font-outfit text-xl text-subtitle">
            {SITE_DESCRIPTION}
          </p>
        ...
        <div className="space-y-6 md:col-start-7">
          <h1 className="font-outfit text-xl font-medium text-title">
            Reach Us
          </h1>
        ...
        <div className="space-y-6 md:col-start-8">
          <h1 className="font-outfit text-xl font-medium text-title">Links</h1>
          <ul className="space-y-4">
